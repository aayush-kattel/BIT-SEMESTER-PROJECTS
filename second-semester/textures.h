...
unsigned int ice_tex;
unsigned int speed_tex;
unsigned int double_tex;
...
void loadAndBindTextures()
{
    ...
    ice_tex        =    load_and_bind_texture("sprites/fruits/ice.png");
    speed_tex     =    load_and_bind_texture("sprites/fruits/speed.png");
    double_tex  =    load_and_bind_texture("sprites/fruits/double.png");
...
{
    glPushMatrix();
    glColor3f(1.0f, 1.0f, 1.0f);   // Set background colour to white to debug texture issues
